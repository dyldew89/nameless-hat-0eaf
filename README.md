...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-hat-0eaf
```

A live public deployment of this template is available at [https://nameless-hat-0eaf.templates.workers.dev](https://nameless-hat-0eaf.templates.workers.dev)
